...
# build vocab, train loader, val loader
...
def train_generator_PG(gen, gen_opt, oracle, dis, num_batches, epoch, log_file='logs_gan_g1k5d3.txt'):
    """
...
if __name__ == '__main__':
    ...
    train_discriminator(dis, dis_optimizer, train_loader, gen, val_loader, D_EPOCHS, k, log_file_2)
    ...
    log_file_3 = 'logs_gan_g100d1k10.txt'
    start_time = time.time()
    for epoch in range(ADV_TRAIN_EPOCHS):
        ...
        sys.stdout.flush()
        train_generator_PG(gen, gen_optimizer, gen, dis, G_STEPS, epoch+MLE_TRAIN_EPOCHS, log_file_3)
        ...
        val_loader = torch.utils.data.DataLoader(val_iter, batch_size=100, shuffle=True, collate_fn=collate_batch)
        train_discriminator(dis, dis_optimizer, train_loader, gen, val_loader, D_STEPS, k, log_file_3)
